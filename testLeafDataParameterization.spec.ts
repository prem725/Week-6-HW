...
// 10. Get the count and print all the values in the Marketing Campaign dropdown 
    const marketingOptions = await page.locator(`#createLeadForm_marketingCampaignId`).allTextContents()
...
// 15. Get the count of all states and print the values in the console
    const states = await page.locator(`#createLeadForm_generalStateProvinceGeoId`).allTextContents()
